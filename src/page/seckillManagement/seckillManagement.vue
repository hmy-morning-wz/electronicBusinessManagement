  ...
  <div>
    <template>
      <div>
        <el-row class="mr20">
          <el-col :span="24">
            <span class="float-left ml20 mt20">秒杀活动管理</span>
          </el-col>
        </el-row>
      </div>
      <el-row>
        ...
        <el-col>
          <div class="float-left ml20 w240">
            <el-date-picker
              v-model="searchParams.gmtStartStart"
              type="datetime"
              placeholder="开始时间-起"
              class="w240 mt20"
          ...
          <div class="float-left ml20 w240">
            <el-date-picker
              type="datetime"
              v-model="searchParams.gmtStartEnd"
              placeholder="开始时间-止"
              class="w240 mt20"
              format="yyyy-MM-dd HH:mm:ss"
              value-format="yyyy-MM-dd HH:mm:ss"
    ...
    return {
      ...
      pickerOptions0: {
            disabledDate: (time) => {
                ...
                if (this.searchParams.gmtStartEnd && this.searchParams.gmtStartEnd != "") {
                  
                    return  time.getTime() > new Date(this.searchParams.gmtStartEnd.replace(/-/g, '/')).getTime() ;
                } else {
        ...
        pickerOptions1: {
            disabledDate: (time) => {
              if (this.searchParams.gmtStartStart && this.searchParams.gmtStartStart != "") {
                return time.getTime() < new Date(this.searchParams.gmtStartStart.replace(/-/g, '/')).getTime() ;
              }else {
                return false ;
              }
