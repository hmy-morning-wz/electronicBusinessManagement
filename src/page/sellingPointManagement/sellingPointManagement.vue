  ...
  <div>
    <template>
      <div>
        <el-row class="mr20">
          <el-col :span="24">
            <span class="float-left ml20 mt20">卖点管理</span>
          </el-col>
        </el-row>
      </div>
      <el-row>
      ...
      <div style="margin-top:20px">
        <el-table :data="labelDataTable" >
          ...
          <el-table-column prop="name" label="卖点名称" min-width="80" align="center"></el-table-column>
          <el-table-column prop="gmtCreate" label="创建时间" min-width="80" align="center">
          </el-table-column>
...
<script>
import categoryManagementService from "../../service/categoryManagement/sellingPointManagement";
